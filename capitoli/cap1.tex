...
\subsubsection{Complessità del problema e algoritmi utilizzabili}
...
polinomiale, e si pensa che non ne esistano\footnote{Vedi la congettura $\mathcal{P} = 
\mathcal{NP}$ nella Sezione \ref{sec:complessitaProblemi}.}.
