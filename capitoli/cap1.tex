...
ricerca in continua crescita negli ultimi anni; l'aumento di risorse logiche
...
fase di progettazione e implementazione di un sistema riconfigurabile. Un esempio di tool
\ac{CAD} è l'\ac{EDK} sviluppato da Xilinx, che gestisce sia i componenti software che
hardware nella fase di design, consentendo di realizzare un sistema riconfigurabile
completo.
