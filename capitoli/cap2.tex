...
compongono l'applicazione. L'overhead introdotto dalla riconfigurazione 
parziale è tenuto in considerazione; tuttavia, non vengono impiegate tecniche 
per mascherare il tempo di riconfigurazione (come il \emph{configuration 
prefetching}), e il collo di bottiglia causato dalle limitazioni del 
controllore della riconfigurazione, che impongono riconfigurazioni non 
sovrapposte nel tempo.

% TODO scendere più nel dettaglio...
