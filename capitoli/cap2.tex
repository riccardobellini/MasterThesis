...
\begin{enumerate}
 \item deve fornire supporto per la riconfigurazione parziale 
...
\caption{Workflow di \acs{FASTER}.}
...
nei quali è possibile sfruttare l'utilizzo della riconfigurazione 2D. 
...
la riga più in basso dell'area decisa per il piazzamento del task.
...
intera, come riportato in \cite{Redaelli2DILP}, il tempo impiegato per risolvere in 
