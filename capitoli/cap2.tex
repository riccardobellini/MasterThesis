...
\paragraph{Configuration prefetching}
...
Nello stesso lavoro, Banerjee et al.~tengono in considerazione i vincoli di 
piazzamento dei task per verificare che la soluzione sia esatta e 
implementabile (ovvero, che tutti i task selezionati per l'esecuzione su 
scheda nella fase di partizionamento siano posizionabili senza violare la 
