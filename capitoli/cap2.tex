...
{capitoli/figure/cap2/FASTERMethodology.png}
\caption{Workflow di \ac{FASTER}.}
\label{fig:FASTERMethodology}
 \end{center}
\end{figure}

La Figura \ref{fig:FASTERMethodology} illustra la panoramica della metodologia 
...
provvista di annotazioni, ad esempio in formato 
...
parallelizzabili e di suddividere l'applicazione nei vari task.}, che ne 
consentono la suddivisione iniziale in task.
