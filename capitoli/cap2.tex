...
Un problema di programmazione lineare intera, in inglese \ac{ILP}, a differenza
di un problema di programmazione lineare (come mostrato nelle precedenti forme),
aggiunge un vincolo di interezza per le variabili decisionali contenute nel vettore 
...
%%% FIXME citare immagine (articolo PARLGRAN di Banerjee)
...
L'algoritmo \ac{ACO}, una meta-euristica moderna, è stato inizialmente 
