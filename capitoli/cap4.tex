...
iterazione è rappresentato da una classe astratta che espone un metodo virtuale 
puro\footnote{Un metodo virtuale puro deve essere implementato da tutte le 
sottoclassi della classe che lo dichiara.} che si occupa di gestire una 
iterazione dell'esplorazione.
