...
(invocato dall'algoritmo evolvibile di esplorazione dello spazio delle soluzioni) ha 
...
Anche l'algoritmo di esplorazione, che si occupa dell'invocazione del tool che gestisce lo 
scheduling, è caratterizzato dalle proprie interfacce di input e output. Come 
si può vedere nella figura \ref{fig:mapperWorkflow}, l'output del mapper e l'interfaccia
...
\subsubsection{Algoritmo di esplorazione}
L'algoritmo di esplorazione delle soluzioni, basato sulla meta-euristica esplorativa \acl{ACO}.
