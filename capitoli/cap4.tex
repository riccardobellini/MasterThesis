...
Il criterio funzione dell'euristica locale e globale che permette all'agente di ordinare le possibili scelte
...
\`E importante notare che la scelta dei task \`e separata rispetto alla scelta del processing element e
...
\subparagraph{Euristica per la selezione del mapping}
...
% TODO FIXME parlare dell'aggiornamento della matrice dei feromoni
...
\subparagraph{Invocazione del tool di scheduling}
...
Ogni task di tipo \emph{READ} e \emph{WRITE} rappresenta una fase astratta che pu\`o
essere implementata a piacere.
...
Per scongiurare il verificarsi di questa situazione, si è introdotto 
