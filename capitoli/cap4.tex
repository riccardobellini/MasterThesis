...
\begin{itemize}
  ...
  \item descrizione del task graph che rappresenta l'applicazione e delle implementazioni
    a disposizione per realizzare la funzionalit\`a di ogni task.
\end{itemize}
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Flusso dettagliato dell'algoritmo di esplorazione.}
...
esplorazione \`e mostrata in figura \ref{fig:flussoDettagliatoACO}.
