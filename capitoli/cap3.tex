...
i due task devono essere eseguiti su logica riconfigurabile.
\end{enumerate}
Se queste condizioni sussistono per una qualsiasi coppia di task, allora 
un nuovo task di riconfigurazione deve essere aggiunto al grafo.

L'inserimento avviene seguendo un preciso ordine per l'introduzione delle 
...
conto delle comunicazioni appena introdotte.
