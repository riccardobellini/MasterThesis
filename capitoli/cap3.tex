...
scheduler, effettuata separatamente in quanto i dati prodotti da questa fase 
devono essere utilizzati solamente dal runtime manager per gestire l'esecuzione 
dell'applicazione.
