...
\begin{figure}
 \begin{minipage}[b]{0.45\textwidth}
  ...
  \subcaption{Prima del postprocessing}
 ...
 \begin{minipage}[b]{0.45\textwidth}
  ...
  \subcaption{Dopo il postprocessing}
  \label{fig:schedulingConflictB}
 \end{minipage}
 \label{fig:schedulingConflict}
 \caption{Esempio di conflitto tra due task e di come tale conflitto venga 
risolto.}
\end{figure}
...
semplice esempio di quando questa situazione si verifica.
%TODO
