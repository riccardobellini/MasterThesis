...
Alla luce di queste considerazioni, si è deciso di sviluppare un algoritmo di scheduling basato su
...
\begin{table}[tb]
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|}
      ...
      \hline
      \ac{ILP} \cite{BanerjeePhysicalConstraints} & Ottima & 1D & X & X\\
      \hline
      \ac{ILP} \cite{Redaelli1DILP} & Ottima & 2D & X & X \\
      \hline
      ...
      \hline
      Soluzione proposta & Sub-ottima & 2D & X & X\\
      \hline
    \end{tabular}
